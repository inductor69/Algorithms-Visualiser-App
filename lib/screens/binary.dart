...
class Code3Screen extends StatefulWidget {
  @override
  _Code3ScreenState createState() => _Code3ScreenState();
}

class _Code3ScreenState extends State<Code3Screen> {
var code3 = '''#include <iostream>
using namespace std;
